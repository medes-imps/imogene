 ...
 * <ul>
 *   <li>{@link org.imogene.model.core.impl.RoleImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoleImpl extends EObjectImpl implements Role {
	...
	protected EClass eStaticClass() {
		return ImogenePackage.Literals.ROLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ImogenePackage.ROLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ImogenePackage.ROLE__NAME:
				return getName();
		}
