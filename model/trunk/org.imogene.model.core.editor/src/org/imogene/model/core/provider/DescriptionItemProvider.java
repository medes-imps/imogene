...
/**
 * This is the item provider adapter for a {@link org.imogene.model.core.Description} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DescriptionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Description_display_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Description_display_feature", "_UI_Description_type"),
				 ImogenePackage.Literals.DESCRIPTION__DISPLAY,
				 true,
				 false,
				 false,
	...
	protected void addHelpPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Description_help_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Description_help_feature", "_UI_Description_type"),
				 ImogenePackage.Literals.DESCRIPTION__HELP,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLocalePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Description_locale_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Description_locale_feature", "_UI_Description_type"),
				 ImogenePackage.Literals.DESCRIPTION__LOCALE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Description.class)) {
			case ImogenePackage.DESCRIPTION__DISPLAY:
			case ImogenePackage.DESCRIPTION__HELP:
			case ImogenePackage.DESCRIPTION__LOCALE:
	...
	public Object getForeground(Object object) {
		...
		return URI.createURI("color://rgb/188/188/188");
	}		
