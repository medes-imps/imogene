...
/**
 * This is the item provider adapter for a {@link org.imogene.model.core.EnumValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ImogenePackage.Literals.ENUM_VALUE__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EnumValue_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EnumValue_name_feature", "_UI_EnumValue_type"),
				 ImogenePackage.Literals.ENUM_VALUE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ImogenePackage.Literals.ENUM_VALUE__DESCRIPTIONS);
		}
    ...
    public String getText(Object object)
    {
        ...
        return label == null || label.length() == 0 ? getString("_UI_EnumValue_type") : getString("_UI_EnumValue_type")
                + " " + label;
    }
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EnumValue.class)) {
			case ImogenePackage.ENUM_VALUE__VALUE:
			case ImogenePackage.ENUM_VALUE__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ImogenePackage.ENUM_VALUE__DESCRIPTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ImogenePackage.Literals.ENUM_VALUE__DESCRIPTIONS,
