...
public class SntpClient {
	...
	private static final String TAG = SntpClient.class.getName();
	...
	public boolean requestTime(String host, int timeout) {
		try {
			...
			long destinationTime = requestTime + (responseTicks - requestTicks);

			long clockOffset = (receiveTime - originateTime + transmitTime - destinationTime) / 2;
			long roundTripTime = destinationTime - originateTime - transmitTime + receiveTime;
