...
public class DialogFactory {
	...
	public static AlertDialog createActivityNotFoundDialog(Context context) {
		return new AlertDialog.Builder(context).setTitle(R.string.ig_anf_title)
				.setIcon(android.R.drawable.ic_dialog_alert).setMessage(R.string.ig_anf)
	...
	public static AlertDialog createIamLostDialog(Context context) {
		return new AlertDialog.Builder(context).setTitle(R.string.ig_iamlost_title)
