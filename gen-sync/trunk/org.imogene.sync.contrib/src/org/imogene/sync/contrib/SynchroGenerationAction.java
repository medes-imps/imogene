package org.imogene.sync.contrib;
...
public class SynchroGenerationAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			wizard.setWindowTitle("Generation of a synchronization server project");
			...
			wizard.setDefinition(FileLocator.openStream(Activator.getDefault()
					...
					false));
			wizard.setWorkflow("workflow/generatorSynchro.mwe");
