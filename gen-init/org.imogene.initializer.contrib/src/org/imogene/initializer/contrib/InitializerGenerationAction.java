package org.imogene.initializer.contrib;
...
public class InitializerGenerationAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		try {
			...
			wizard.setWindowTitle("Generation of an initializer project");
			...
			wizard.setDefinition(FileLocator.openStream(Activator.getDefault()
					...
					false));
			wizard.setWorkflow("workflow/generatorInitializer.mwe");
