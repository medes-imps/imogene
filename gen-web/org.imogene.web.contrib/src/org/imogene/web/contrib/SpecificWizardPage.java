...
public class SpecificWizardPage extends WizardPage implements GenerationWizardPage, SelectionListener {
	...
	public void createControl(Composite parent) {
		...
		/*
		 * geckoButton = new Button(navigatorGroup, SWT.CHECK); geckoButton.setText("Mozilla 1.8");
		 * geckoButton.setSelection(true); geckoButton.addSelectionListener(this);
		 */
	...
	private String getProperty() {
		...
		/*
		 * if(geckoButton.getSelection()) buffer.append(GECKO).append(SEPARATOR);
		 */
	...
	private boolean validate() {
		boolean valid = /*
						 * geckoButton.getSelection() ||
						 */gecko18Button.getSelection() || operaButton.getSelection() || safariButton.getSelection()
				|| ie6Button.getSelection() || ie8Button.getSelection();
		if (!valid) {
