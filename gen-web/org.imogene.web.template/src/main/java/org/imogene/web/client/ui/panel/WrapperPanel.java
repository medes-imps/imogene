 ...
 * @author Medes-IMPS
 */
public class WrapperPanel extends Composite implements HasWidgets {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, WrapperPanel> {
	}
	 ...
	 * @param pChild
	 */
	public WrapperPanel(String pTitle, Widget pChild) {		
