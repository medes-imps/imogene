...
/**
 * Filter panel to filter the ImogRole entries
 * @author MEDES-IMPS
 */
public class ImogRoleFilterPanel extends ImogFilterPanel {

	/* filter widgets */
	private TextBox nameBox;
	private ImogFilterBox nameFilterBox;

	public ImogRoleFilterPanel() {
		super();
		setFieldReadAccess();
	}
	...
	public void createFilterWidgets() {
		...
		nameFilterBox.setFilterLabel(AdminNLS.constants().imogRole_field_name());
	...
	public List<FilterCriteria> getFilterCriteria() {
		...
		nameCrit.setFieldDisplayName(AdminNLS.constants().imogRole_field_name());
