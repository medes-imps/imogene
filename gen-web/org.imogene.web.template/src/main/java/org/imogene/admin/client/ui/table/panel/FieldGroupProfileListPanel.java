...
import org.imogene.admin.client.ui.table.FieldGroupProfileDynaTable;
...
/**
 * Panel that contains the FieldGroupProfile Dynatable
 * 
 * @author Medes-IMPS
 */
public class FieldGroupProfileListPanel extends Composite {

	private static final Binder uiBinder = GWT.create(Binder.class);

	interface Binder extends UiBinder<Widget, FieldGroupProfileListPanel> {
	}
	...
	@UiField(provided = true)
	FieldGroupProfileDynaTable listComposite;
	 ...
	 */
	public FieldGroupProfileListPanel(AdminRequestFactory requestFactory, String searchText) {
		...
		wrapperPanel.setTitle(AdminNLS.constants().fieldGroupProfile_table_text());

		/* data provider */
		FieldGroupProfileDataProvider provider = new FieldGroupProfileDataProvider(requestFactory);
	 ...
	 * @param requestFactory
	 */
	public FieldGroupProfileListPanel(AdminRequestFactory requestFactory) {
		this(requestFactory, null);
	}

	/**
	 * Configures the Data provider that enables to get the data to feed the table that lists FieldGroupProfile entries
	 * 
	 * @param provider
	 * @param searchText
	 * @return
	 */
	private String configureDataProvider(FieldGroupProfileDataProvider provider, String searchText) {
	...
	/**
	 * Configures the Wrapper panel to manage the actions that are related to the table that lists FieldGroupProfile
	 * entries
	 */
